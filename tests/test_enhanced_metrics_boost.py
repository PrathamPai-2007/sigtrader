...
def test_quality_label_consistent_with_score():
    ...
    from analyzer.analysis.models import QualityLabel
...
def test_rsi_overbought_reduces_long_confidence():
    ...
    analyzer = SetupAnalyzer()
    from analyzer.analysis.scorer import _SideMetrics, _quality_label
    from analyzer.analysis.models import EnhancedMetrics, QualityLabel
...
def test_rsi_neutral_zone_boosts_confidence():
    ...
    analyzer = SetupAnalyzer()
    from analyzer.analysis.scorer import _SideMetrics
    from analyzer.analysis.models import EnhancedMetrics, QualityLabel
