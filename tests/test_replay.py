...
from analyzer.analysis import MarketMode, StrategyStyle
from analyzer.analysis.models import AnalysisResult, Candle, MarketMeta, MarketRegime, QualityLabel, TimeframePlan, TradeSetup
...
def test_replay_returns_latest_tradable_trigger_timestamp(monkeypatch) -> None:
    ...
    monkeypatch.setattr("analyzer.analysis.replay.SetupAnalyzer.analyze", fake_analyze)
