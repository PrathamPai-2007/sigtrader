...
from analyzer.analysis.models import AnalysisResult
from history.models import HistorySnapshot, SnapshotEvaluation
...
class HistoryRepository:
    ...
    def _connect(self) -> sqlite3.Connection:
        conn = sqlite3.connect(self.db_path, timeout=_BUSY_TIMEOUT_MS / 1000, factory=ClosingConnection)
    ...
    def save_enhanced_metrics(self, snapshot_id: int, metrics: "EnhancedMetrics") -> None:
        from analyzer.analysis.models import EnhancedMetrics
        with self._connect() as conn:
            conn.execute(
                """
