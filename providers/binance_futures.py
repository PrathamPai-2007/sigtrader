...
from analyzer.analysis.models import Candle, MarketMeta, MarketMode
from analyzer.analysis.validation import CandleValidator, DataValidationError
...
class BinanceFuturesProvider:
    ...
    def __init__(self, timeout: float = 20.0) -> None:
        ...
        from providers.microstructure import EnhancedDataProvider
    ...
    async def fetch_klines(
        ...
        *,
        ...
        if warnings:
            from analyzer.logging import get_logger as _get_logger
