...
from analyzer.analysis.scorer import (
...
from analyzer.config import PortfolioConfig, StrategyConfig
...
class TestDrawdownAdjuster:
    ...
    def test_quality_label_updated_after_penalty(self) -> None:
        ...
        from analyzer.analysis.scorer import _quality_label
...
from analyzer.analysis.models import StrategyStyle
from analyzer.analysis.scorer import (
    SwingPoints,
    EntryGeometry,
...
from analyzer.analysis.scorer import EntryGeometry, geometry_quality_score
